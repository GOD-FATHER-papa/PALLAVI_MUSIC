...
async def init():
    ...
    LOGGER("AnonMusic").info(
        "\x41\x6e\x6f\x6e\x20\x4d\x75\x73\x69\x63\x20\x53\x74\x61\x72\x74\x65\x64\x20\x53\x75\x63\x63\x65\x73\x73\x66\x75\x6c\x6c\x79\x2e"
    )
    await idle()
    await app.stop()
    await userbot.stop()
    LOGGER("AnonMusic").info("Stopping Anony Music Bot...")
